			...
			<div class="row-fluid">
				<div class="box span12">
                  ...
                  <div class="control-group">
	                ...
	                <div class="control-group">
									...
									<div class="control-group">
									  ...
									  <div class="controls">
											<input type="text" name="no_coeplim" id="no_coeplim" class="span12" value="<?php echo set_value('no_coeplim'); ?>"
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" name="hectareas" id="hectareas" class="span12" value="<?php echo set_value('hectareas'); ?>"
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" name="pequena_propiedad" id="pequena_propiedad" class="span12" value="<?php echo set_value('pequena_propiedad'); ?>"
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" name="propietario" id="propietario" class="span12" value="<?php echo set_value('propietario'); ?>"
