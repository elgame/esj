      ...
      <div class="row-fluid">
        ...
        <div class="box span12">
          <div class="box-header well" data-original-title>
            <h2><i class="icon-edit"></i> Modificar tamaño</h2>
            <div class="box-icon">
          ...
          <div class="box-content">
            ...
            <form action="<?php echo base_url('panel/areas_otros/modificar_tamano/?'.MyString::getVarsLink(array('msg', 'fstatus'))); ?>" method="post" class="form-horizontal">
              <div class="control-group">
                <label class="control-label" for="fnombre">Nombre </label>
                <div class="controls">
                  <input type="text" name="fnombre" id="fnombre" class="span6" maxlength="30"
                  value="<?php echo (isset($data['info']->nombre)? $data['info']->nombre: ''); ?>" required autofocus placeholder="VDE # 5G, ECO-VDE # 2, No.5">
                </div>
              </div>
