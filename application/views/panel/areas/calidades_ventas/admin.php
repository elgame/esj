                ...
                <table class="table table-striped table-bordered bootstrap-datatable">
                  ...
                  <tbody id="acal_body">
                 <?php
                 foreach($calidades_ventas['calidades'] as $calidad){
                  ?>
                    <tr>
                      ...
                      <td class="center">
                          <?php
                          echo $this->usuarios_model->getLinkPrivSm('areas_otros/modificar_calidad/', array(
                              'params'   => 'id='.$calidad->id_calidad.'&idarea='.$this->input->get('id'),
                              'text_link' => 'hide',
                              'btn_type' => 'btn-success')
                          );
                          if ($calidad->status == 't') {
                            echo $this->usuarios_model->getLinkPrivSm('areas_otros/eliminar_calidad/', array(
                                'params'   => 'id='.$calidad->id_calidad.'&idarea='.$this->input->get('id'),
                                'btn_type' => 'btn-danger',
                                'text_link' => 'hide',
                            ...
                            echo $this->usuarios_model->getLinkPrivSm('areas_otros/activar_calidad/', array(
                                'params'   => 'id='.$calidad->id_calidad.'&idarea='.$this->input->get('id'),
                                'btn_type' => 'btn-danger',
                                'text_link' => 'hide',
                ...
                $this->pagination->initialize(array(
                    ...
                    'total_rows'    => $calidades_ventas['total_rows'],
                    'per_page'      => $calidades_ventas['items_per_page'],
                    'cur_page'      => $calidades_ventas['result_page']*$calidades_ventas['items_per_page'],
