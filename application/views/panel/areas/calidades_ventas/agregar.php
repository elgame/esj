      ...
      <div class="row-fluid">
        ...
        <div class="box span12">
          ...
          <div class="box-content">
            ...
            <form action="<?php echo base_url('panel/areas_otros/agregar_calidad/?'.MyString::getVarsLink(array('msg', 'fstatus'))); ?>" method="post" class="form-horizontal">
              <div class="control-group">
                <label class="control-label" for="fnombre">Nombre </label>
                <div class="controls">
                  <input type="text" name="fnombre" id="fnombre" class="span6" maxlength="20"
                  value="<?php echo set_value('fnombre'); ?>" required autofocus placeholder="300, MIX, PREM, 1ra">
                </div>
              </div>
              ...
              <div class="form-actions">
                ...
                <a href="<?php echo base_url('panel/areas_otros/modificar/?id='.$this->input->get('id')); ?>" class="btn">Cancelar</a>
              </div>
            </form>
