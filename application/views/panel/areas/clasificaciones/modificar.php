          ...
          <div class="box-content">
            ...
            <form action="<?php echo base_url('panel/areas/modificar_clasificacion/?'.MyString::getVarsLink(array('msg', 'fstatus'))); ?>" method="post" class="form-horizontal">
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="fnombre" id="fnombre" class="span6" maxlength="1000"
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="checkbox" name="ieps_subtotal" id="ieps_subtotal" value="si" <?php echo set_checkbox('ieps_subtotal', 't', ($data['info']->ieps_subtotal=='t'?true:false)) ?>>
                </div>
              </div>
