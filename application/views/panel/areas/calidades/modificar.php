      ...
      <div class="row-fluid">
        ...
        <div class="box span12">
          ...
          <div class="box-content">
            ...
            <form action="<?php echo base_url('panel/areas/modificar_calidad/?'.MyString::getVarsLink(array('msg', 'fstatus'))); ?>" method="post" class="form-horizontal">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  ...
                  value="<?php echo (isset($data['info']->precio_compra)? $data['info']->precio_compra: ''); ?>" required placeholder="4.4, 33">
                </div>
              </div>
