			...
			<div class="row-fluid">
				<div class="box span12">
	                ...
	                <div class="control-group">
	                  ...
	                  <div class="controls">
	                    <input type="text" name="dubicacion" id="dubicacion" value="<?php echo set_value('dubicacion', $areas->ubicacion); ?>" class="input-xlarge">
	                  </div>
	                </div>
	                ...
	                <div class="control-group">
	                  ...
	                  <div class="controls">
	                    <input type="text" name="dotro_dato" id="dotro_dato" value="<?php echo set_value('dotro_dato', $areas->otro_dato); ?>" class="input-xlarge">
	                  </div>
	                </div>
	                ...
	                <div class="control-group">
	                  ...
	                  <div class="controls" style="margin-left: 120px;">
	                  	<div style="height: 300px; overflow-y: auto; border:1px #ddd solid;">
	                  		<?php echo $this->catalogos_sft_model->getFrmCatCodigos(0, true, ($areas->id_padre==''? '0': $areas->id_padre), true); ?>
	                    </div>
	                  </div>
	                </div>
	              </div> <!--/span-->
