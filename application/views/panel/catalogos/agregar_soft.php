			...
			<div class="row-fluid">
				<div class="box span12">
					...
					<div class="box-content">
						<form action="<?php echo base_url('panel/catalogos_sft/agregar_soft'); ?>" method="post" class="form-horizontal" id="form">
						  <fieldset>
								<legend></legend>
	                ...
	                <div class="control-group">
	                  ...
	                  <div class="controls" style="margin-left: 120px;">
	                  	<div style="height: 300px; overflow-y: auto; border:1px #ddd solid;">
	                  		<?php echo $this->catalogos_sft_model->getFrmCatSoft(0, true, 'radio', true); ?>
	                    </div>
	                  </div>
	                </div>
	              </div> <!--/span-->
                  ...
                  <a href="<?php echo base_url('panel/catalogos_sft/cat_soft/'); ?>" class="btn">Cancelar</a>
								</div>
						  </fieldset>
						</form>
