...
?>
  ...
  <body>
    ...
    <div class="modal-header">
      <h3><?php echo $empresa->nombre_fiscal ?> | Cultivo: <?php echo $_GET['cultivo'] ?> | Fecha: <?php echo $_GET['fecha'] ?>
    ...
    <div class="modal-body" style="max-height: none;">
      <form class="form-horizontal" action="<?php echo base_url('panel/recetas/show_import_recetas_corona/?'.MyString::getVarsLink(array('msg'))); ?>" method="POST" enctype="multipart/form-data">
        <div>
          <label>Seleccionar archivo de recetas: <input type="file" name="archivo_recetas" placeholder=""></label>
          <!-- accept=".txt" -->
