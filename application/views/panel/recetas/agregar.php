            ...
            <div class="box span12">
              ...
              <div class="box-content">
                <div class="row-fluid">
                  <div class="span3">
                    Semana
                    <input type="text" name="ar_semana" class="span12 datosapl" id="ar_semana" value="<?php echo set_value('ar_semana') ?>">
                  </div>

                  <div class="span3">
                    Fecha
                    <input type="datetime-local" name="ar_fecha" class="span12 datosapl" id="ar_fecha" value="<?php echo set_value('ar_fecha') ?>">
                  </div>

                  <div class="span3">
                    PH
                    <input type="text" name="ar_ph" class="span12 datosapl" id="ar_ph" value="<?php echo set_value('ar_ph') ?>">
                  </div>
                </div>
