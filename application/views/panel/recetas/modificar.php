                ...
                <div class="controls">
                  <div class="input-append span12">
                    ...
                    <select name="objetivo" class="span12 datosapl" id="objetivo">
                      <option value=""></option>
                      <option value="Nutrición Foliar" <?php echo set_select('objetivo', 'Nutrición Foliar', ($receta['info']->objetivo==='Nutrición Foliar')); ?>>Nutrición Foliar</option>
                      <option value="Nutrición Fisica" <?php echo set_select('objetivo', 'Nutrición Fisica', ($receta['info']->objetivo==='Nutrición Fisica')); ?>>Nutrición Fisica</option>
                      <option value="Control Plaga & Enf." <?php echo set_select('objetivo', 'Control Plaga & Enf.', ($receta['info']->objetivo==='Control Plaga & Enf.')); ?>>Control Plaga & Enf.</option>
