      ...
      <div class="row-fluid">
        <div class="box span12">
          ...
          <div class="box-content">
            <form action="<?php echo base_url('panel/proveedores_facturacion/series_folios/'); ?>" method="GET" class="form-search">
            ...
            <?php
            echo $this->usuarios_model->getLinkPrivSm('proveedores_facturacion/agregar_serie_folio/', array(
                    'params'   => '',
            ...
            <?php foreach($datos_s['series'] as $serie) {?>
                <tr>
                  <td><?php echo $serie->proveedor; ?></td>
                  ...
                  <td class="center">
                    <?php
                      echo $this->usuarios_model->getLinkPrivSm('proveedores_facturacion/modificar_serie_folio/', array(
