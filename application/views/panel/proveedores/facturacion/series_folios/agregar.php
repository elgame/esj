  ...
  <div class="row-fluid">
    <div class="box span12">
      ...
      <div class="box-content">
        <form class="form-horizontal" action="<?php echo base_url('panel/proveedores_facturacion/agregar_serie_folio');?>" method="POST" enctype="multipart/form-data">

            <div class="control-group">
              <label for="fproveedor" class="control-label">Proveedor</label>
              <div class="controls">
                <input type="text" name="fproveedor" class="span6" id="fproveedor" value="<?php echo set_value('fproveedor'); ?>" autofocus>
                <input type="hidden" name="fid_proveedor" id="fid_proveedor" value="<?php echo set_value('fid_proveedor'); ?>">
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="checkbox" name="fnota_credito" id="fnota_credito" value="1" <?php echo set_checkbox('fnota_credito', '1') ?>>
              </div>
            </div>
