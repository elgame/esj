<div id="content" class="span10">
  ...
  <div>
    <ul class="breadcrumb">
      ...
      <li>
        <a href="<?php echo base_url('panel/proveedores_facturacion/series_folios/'); ?>">Series y Folios</a> <span class="divider">/</span>
      </li>
      <li>Modificar</li>
    </ul>
  </div>
   ...
   <div class="row-fluid">
    <div class="box span12">
      <div class="box-header well" data-original-title>
        <h2><i class="icon-user"></i> Series y Folios</h2>
        <div class="box-icon">
      ...
      <div class="box-content">
        ...
        <form class="form-horizontal" action="<?php echo base_url('panel/proveedores_facturacion/modificar_serie_folio?id='.$_GET['id']);?>" method="POST" enctype="multipart/form-data">

            <div class="control-group">
              <label for="fproveedor" class="control-label">Proveedor</label>
              <div class="controls">
                <input type="text" name="fproveedor" class="span6" id="fproveedor" value="<?php echo (isset($serie_info[0]->serie)) ? $serie_info[0]->proveedor : set_value('fproveedor') ?>" autofocus>
                <input type="hidden" name="fid_proveedor" id="fid_proveedor" value="<?php echo (isset($serie_info[0]->serie)) ? $serie_info[0]->id_proveedor : set_value('fid_proveedor') ?>">
              </div>
            </div>
