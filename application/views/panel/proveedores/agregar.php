			...
			<div class="row-fluid">
				<div class="box span12">
						  ...
						  <fieldset>
								...
								<div class="span5">
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="plazoCredito" class="span9 vpos-int" id="plazoCredito" value="<?php echo set_value('plazoCredito', '15'); ?>">
										</div>
									</div>
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="checkbox" name="retIsrBascula" class="span9" id="retIsrBascula" value="si" <?php echo set_checkbox('retIsrBascula', 'si') ?>>
                    </div>
                  </div>
