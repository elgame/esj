              ...
              <tr>
                ...
                <td class="center">
                    ...
                    if ($paleta->status != 'ca') {
                      ...
                      echo $this->usuarios_model->getLinkPrivSm('rastreabilidad_paletas/cancelar/', array(
                          'params'   => 'id='.$paleta->id_paleta_salida,
                          'btn_type' => 'btn-danger',
                    ...
                    if ($paleta->status !== 'f' && $paleta->status !== 'ca' && $this->usuarios_model->tienePrivilegioDe('', 'rastreabilidad_paletas/remisionar/')) {
