      ...
      <div class="row-fluid">
        <div class="box span12">
          <div class="box-content">
            <form action="<?php echo base_url('panel/rastreabilidad/rrs_pdf/'); ?>" method="GET" id="form-search" class="form-search" target="rdeReporte">
              <div class="form-actions form-filters">
                ...
                <div class="control-group">
                  <label class="control-label" for="flotes">Lotes</label>
                  <div class="controls">
                    <select name="flotes" id="flotes" class="span12" required>
                      <option value=""></option>
                      <?php foreach ($lotes as $key => $lote) { ?>
                        <option value="<?php echo $lote->id_rendimiento.'-'.$lote->lote ?>"><?php echo $lote->lote_ext ?></option>
                      <?php } ?>
                    </select>
                  </div>
                </div>
          ...
          <div class="box-content">
            <div class="row-fluid">
              <iframe name="rdeReporte" id="iframe-reporte" class="span12" 
                src="<?php echo base_url('panel/rastreabilidad/rrs_pdf/?farea='.$area_default)?>" style="height:520px;"></iframe>
            </div>
          </div>
        </div><!--/span-->
      </div><!--/row-->
