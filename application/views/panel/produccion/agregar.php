<div id="content" class="span10">
  ...
  <div>
    <ul class="breadcrumb">
      ...
      <li>
        <a href="<?php echo base_url('panel/produccion/'); ?>">Ordenes de produccion</a> <span class="divider">/</span>
      </li>
      <li>Agregar</li>
    </ul>
  </div>
  ...
  <div class="row-fluid">
    <div class="box span12">
      ...
      <div class="box-content">
        ...
        <form class="form-horizontal" action="<?php echo base_url('panel/produccion/agregar/?'.String::getVarsLink(array('msg'))); ?>" method="POST" id="form">
