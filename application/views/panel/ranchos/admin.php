			...
			<div class="row-fluid">
				<div class="box span12">
					...
					<div class="box-content">
						<form action="<?php echo base_url('panel/ranchos/'); ?>" method="get" class="form-search">
							<fieldset>
                ...
                <input type="hidden" name="did_area" value="<?php echo set_value_get('did_area'); ?>" id="did_area">|
						...
						<?php
						echo $this->usuarios_model->getLinkPrivSm('ranchos/agregar/', array(
										'params'   => '',
						...
						<table class="table table-striped table-bordered bootstrap-datatable">
						  ...
						  <tbody>
						<?php foreach($ranchos['ranchos'] as $rancho){ ?>
							<tr>
								<td><?php echo $rancho->nombre; ?></td>
								<td><?php echo $rancho->empresa; ?></td>
								<td><?php echo $rancho->area; ?></td>
								<td>
									<?php
										if($rancho->status == 't'){
											$v_status = 'Activo';
								...
								<td class="center">
										<?php
										echo $this->usuarios_model->getLinkPrivSm('ranchos/modificar/', array(
												'params'   => 'id='.$rancho->id_rancho,
												'btn_type' => 'btn-success')
										);
										if ($rancho->status == 't') {
											echo $this->usuarios_model->getLinkPrivSm('ranchos/eliminar/', array(
														'params'   => 'id='.$rancho->id_rancho,
														'btn_type' => 'btn-danger',
														'attrs' => array('onclick' => "msb.confirm('Estas seguro de eliminar el rancho?', 'ranchos', this); return false;"))
											);
										}else{
											echo $this->usuarios_model->getLinkPrivSm('ranchos/activar/', array(
													'params'   => 'id='.$rancho->id_rancho,
													'btn_type' => 'btn-danger',
													'attrs' => array('onclick' => "msb.confirm('Estas seguro de activar el rancho?', 'ranchos', this); return false;"))
											);
										}
					...
					<?php }?>
					  ...
					  <?php
						...
						$this->pagination->initialize(array(
								...
								'total_rows'		=> $ranchos['total_rows'],
								'per_page'			=> $ranchos['items_per_page'],
								'cur_page'			=> $ranchos['result_page']*$ranchos['items_per_page'],
