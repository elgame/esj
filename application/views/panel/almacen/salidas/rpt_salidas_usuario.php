      ...
      <div class="row-fluid">
        <div class="box span12">
          <div class="box-content">
            <form id="form" action="<?php echo base_url('panel/productos_salidas/rpt_salidas_usuarios_pdf/'); ?>" method="GET" class="form-search" target="frame_reporte">
              <div class="form-actions form-filters">
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="text" name="fusuario" data-add="false"
                      value="<?php echo set_value_get('fusuario', $this->input->get('fusuario')) ?>" id="fusuario" class="span11" placeholder="Nombre">
                    <input type="hidden" name="fid_usuario" value="<?php echo set_value_get('fid_usuario', $this->input->get('fid_usuario')) ?>" id="fid_usuario">
                  </div>
                </div>
    ...
    <div id="content" class="span9">
      ...
      <div class="box span12">
        <!-- <a href="" id="linkDownXls" data-url="<?php echo base_url('panel/productos_salidas/rpt_salidas_usuario_xls'); ?>" class="linksm" target="_blank">
          <i class="icon-table"></i> Excel</a> -->
        <div class="box-content">
          <div class="row-fluid">
            <iframe id="frame_reporte" name="frame_reporte" src="<?php echo base_url('panel/productos_salidas/rpt_salidas_usuarios_pdf/'); ?>" style="width: 100%;height: 475px;"></iframe>
          </div>
        </div>
      </div><!--/span-->
