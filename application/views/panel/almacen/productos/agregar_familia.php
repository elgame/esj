      ...
      <div class="row-fluid">
        ...
        <div class="box span12">
          <div class="box-header well" data-original-title>
            <h2><i class="icon-plus"></i> Agregar Familias</h2>
            <div class="box-icon">
          ...
          <div class="box-content">
            ...
            <form action="<?php echo base_url('panel/productos/agregar_familia/?'.String::getVarsLink(array('msg', 'fstatus'))); ?>" method="post" class="form-horizontal">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="fempresa" value="<?php echo set_value('fempresa') ?>" id="fempresa" class="span6" placeholder="Empresa" required autofocus>
                  <input type="hidden" name="fid_empresa" value="<?php echo set_value('fid_empresa') ?>" id="fid_empresa" required>
                </div>
              </div>
