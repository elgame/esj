      ...
      <div class="row-fluid">
        <div class="box span12">
          <div class="box-content">
            <form id="form" action="<?php echo base_url('panel/inventario/formatoInventario_pdf/'); ?>" method="GET" class="form-search" target="frame_reporte">
    ...
    <div id="content" class="span9">
      ...
      <div class="box span12">
        <a href="" id="linkDownXls" data-url="<?php echo base_url('panel/inventario/formatoInventario_xls'); ?>" class="linksm" target="_blank">
          <i class="icon-table"></i> Excel</a>
        <div class="box-content">
          <div class="row-fluid">
            <iframe id="frame_reporte" name="frame_reporte" src="<?php echo base_url('panel/inventario/formatoInventario_pdf/'); ?>" style="width: 100%;height: 475px;"></iframe>
          </div>
        </div>
      </div><!--/span-->
