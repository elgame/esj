      ...
      <div class="row-fluid">
        <div class="box span12">
          <div class="box-content">
            <form action="<?php echo base_url('panel/inventario/ueps_pdf/'); ?>" method="GET" class="form-search" target="frame_reporte">
    ...
    <div id="content" class="span9">
      ...
      <iframe id="frame_reporte" src="<?php echo base_url('panel/inventario/ueps_pdf/'); ?>" style="width: 100%;height: 475px;"></iframe>
