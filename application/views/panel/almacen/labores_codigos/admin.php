      ...
      <div class="row-fluid">
        <div class="box span12">
          ...
          <div class="box-content">
            <form action="<?php echo base_url('panel/labores_codigo/'); ?>" method="GET" class="form-search">
            ...
            <?php
              echo $this->usuarios_model->getLinkPrivSm('labores_codigo/agregar/', array(
                'params'   => '',
                ...
                <tr>
                  ...
                  <td class="center">
                    <?php
                      if ($labor->status === 't')
                      {
                        echo $this->usuarios_model->getLinkPrivSm('labores_codigo/modificar/', array(
                          'params'   => 'id='.$labor->id_labor,
                          'btn_type' => 'btn-success',
                          'attrs' => array())
                        );

                        echo $this->usuarios_model->getLinkPrivSm('labores_codigo/eliminar/', array(
                          'params'   => 'id='.$labor->id_labor,
                          'btn_type' => 'btn-danger',
