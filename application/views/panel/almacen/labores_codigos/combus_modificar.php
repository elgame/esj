<div id="content" class="span10">
  ...
  <div>
    <ul class="breadcrumb">
      ...
      <li>
        <a href="<?php echo base_url('panel/labores_codigo/combus/'); ?>">Labores</a> <span class="divider">/</span>
      </li>
      <li>Moficiar</li>
    </ul>
  </div>
  ...
  <div class="row-fluid">
    <div class="box span12">
      ...
      <div class="box-content">
        ...
        <form class="form-horizontal" action="<?php echo base_url('panel/labores_codigo/combus_modificar/?'.MyString::getVarsLink(array('msg'))); ?>" method="POST" id="form">
