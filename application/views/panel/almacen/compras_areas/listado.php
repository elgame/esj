		...
		<div id="content" class="span10">
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="#">Maquinaria, equicos e instalaciones</a>
					</li>
				</ul>
			</div>
			...
			<div class="row-fluid">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-file"></i> Maquinaria, equicos e instalaciones</h2>
						<div class="box-icon">
							<a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
						</div>
					</div>
					<div class="box-content">
						<form action="<?php echo base_url('panel/compras_areas/'); ?>" method="get" class="form-search">
							<fieldset>
						...
						<?php 
						echo $this->usuarios_model->getLinkPrivSm('compras_areas/agregar/', array(
										'params'   => '',
						...
						<?php foreach($areas['areas'] as $area){ ?>
								<tr>
									...
									<td class="center">
										<?php 
										echo $this->usuarios_model->getLinkPrivSm('compras_areas/modificar/', array(
												'params'   => 'id='.$area->id_area,
												'btn_type' => 'btn-success')
										);
										echo $this->usuarios_model->getLinkPrivSm('compras_areas/eliminar/', array(
												'params'   => 'id='.$area->id_area,
												'btn_type' => 'btn-danger',
