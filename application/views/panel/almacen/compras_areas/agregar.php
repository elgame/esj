		<div id="content" class="span10">
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?php echo base_url('panel/compras_areas'); ?>">Maquinaria, equicos e instalaciones</a> <span class="divider">/</span>
					</li>
					<li>Agregar</li>
				</ul>
			</div>
			...
			<div class="row-fluid">
				<div class="box span12">
					...
					<div class="box-content">
						<form action="<?php echo base_url('panel/compras_areas/agregar'); ?>" method="post" class="form-horizontal" id="form">
						  <fieldset>
								<legend></legend>
	                ...
	                <div class="control-group">
	                  ...
	                  <div class="controls" style="margin-left: 120px;">
	                  	<div style="height: 300px; overflow-y: auto; border:1px #ddd solid;">
	                  		<?php echo $this->compras_areas_model->getFrmAreas(0, true, 'radio', true); ?>
	                    </div>
	                  </div>
	                </div>
	              </div> <!--/span-->
                  ...
                  <a href="<?php echo base_url('panel/compras_areas/'); ?>" class="btn">Cancelar</a>
								</div>
						  </fieldset>
						</form>
