  ...
  <div class="row-fluid">
    <div class="box span12">
      <div class="box-header well" data-original-title>
        <h2><i class="icon-plus"></i> Regresar productos</h2>
        <div class="box-icon">
      ...
      <div class="box-content">
        ...
        <form class="form-horizontal" action="<?php echo base_url('panel/productos_regreso/agregar/?'.MyString::getVarsLink(array('msg'))); ?>" method="POST" id="form">
...
<?php if (floatval($prints) > 0) { ?>
  <script>
    var win=window.open(<?php echo "'".base_url('panel/compras_ordenes/ticket/?id=' . $prints."'") ?>, '_blank');
    win.focus();
  </script>
<?php } ?>
<!-- Bloque de alertas -->
