    <div id="content" class="span10">
      ...
      <div>
        <ul class="breadcrumb">
          ...
          <li>
            <a href="<?php echo base_url('panel/empleadosr/'); ?>">Empleados</a> <span class="divider">/</span>
          </li>
          <li>Modificar</li>
        </ul>
      </div>
      ...
      <div class="row-fluid">
        <div class="box span12">
          ...
          <div class="box-content">
            <form action="<?php echo base_url('panel/empleadosr/modificar/?id='.$_GET['id']); ?>" method="post" class="form-horizontal">
              <fieldset>
                <legend></legend>
