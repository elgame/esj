...
?>
  ...
  <body>
    ...
    <div class="modal-body" style="max-height: none;">
      <form class="form-horizontal" action="<?php echo base_url('panel/nomina_fiscal/show_import_nomina_corona/?'.MyString::getVarsLink(array('msg'))); ?>" method="POST" enctype="multipart/form-data">
        <div>
          <label>Seleccionar archivo de nomina: <input type="file" name="archivo_nomina" placeholder=""></label>
          <!-- accept=".txt" -->
