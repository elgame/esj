                ...
                <div class="row-fluid">
                  <div class="span12">
                    <table class="table table-striped table-bordered table-hover table-condensed" id="table-incapacidades">
                      ...
                      <tbody>
                        <tr>
                          <td style="width: 60px;"><input type="text" name="ifolio" value="<?php echo set_value('ifolio', (isset($incapacidades->tipo)?$incapacidades->folio:'') ); ?>" class="span12" required> </td>
                          <td style="width: 100px;">
                            <input type="hidden" name="iid_asistencia" value="<?php echo (isset($incapacidades->tipo)?$incapacidades->id_asistencia:'') ?>">
                            <select name="itipo_inciden" class="span12">
                            <?php foreach ($sat_incapacidades as $key => $tipo) { ?>
                              <option value="<?php echo $tipo->id_clave ?>" <?php echo set_select('itipo_inciden', $tipo->id_clave, false, (isset($incapacidades->tipo)?$incapacidades->id_clave:'0')); ?>><?php echo $tipo->nombre ?></option>
                            <?php } ?>
                            </select>
                          </td>
                          <td style="width: 80px;"><input type="date" name="ifecha" value="<?php echo set_value('ifecha', (isset($incapacidades->tipo)?$incapacidades->fecha_ini:$semana['fecha_inicio']) ); ?>" class="span12 ifecha" required> </td>
                          <td style="width: 100px;"><input type="number" name="idias" value="<?php echo set_value('idias', (isset($incapacidades->tipo)?$incapacidades->dias_autorizados:'0') ); ?>" class="span12" required> </td>
                          <td style="width: 100px;">
                            <select name="iramo_seguro" class="span12">
                              <option value="Riesgo de Trabajo" <?php echo set_select('iramo_seguro', 'Riesgo de Trabajo', false, (isset($incapacidades->tipo)?$incapacidades->ramo_seguro:'0')); ?>>Riesgo de Trabajo</option>
                              <option value="Enfermedad General" <?php echo set_select('iramo_seguro', 'Enfermedad General', false, (isset($incapacidades->tipo)?$incapacidades->ramo_seguro:'0')); ?>>Enfermedad General</option>
                              <option value="Maternitad Prenatal" <?php echo set_select('iramo_seguro', 'Maternitad Prenatal', false, (isset($incapacidades->tipo)?$incapacidades->ramo_seguro:'0')); ?>>Maternitad Prenatal</option>
                              <option value="Maternitad Postnatal" <?php echo set_select('iramo_seguro', 'Maternitad Postnatal', false, (isset($incapacidades->tipo)?$incapacidades->ramo_seguro:'0')); ?>>Maternitad Postnatal</option>
                            </select>
                          </td>
                          <td style="width: 100px;">
                            <select name="icontrol_incapa" class="span12">
                              <option value="Unica" <?php echo set_select('icontrol_incapa', 'Unica', false, (isset($incapacidades->tipo)?$incapacidades->control_incapacidad:'0')); ?>>Unica</option>
                              <option value="Inicial" <?php echo set_select('icontrol_incapa', 'Inicial', false, (isset($incapacidades->tipo)?$incapacidades->control_incapacidad:'0')); ?>>Inicial</option>
                              <option value="Subsecuente" <?php echo set_select('icontrol_incapa', 'Subsecuente', false, (isset($incapacidades->tipo)?$incapacidades->control_incapacidad:'0')); ?>>Subsecuente</option>
                              <option value="Alta Medica o ST-2" <?php echo set_select('icontrol_incapa', 'Alta Medica o ST-2', false, (isset($incapacidades->tipo)?$incapacidades->control_incapacidad:'0')); ?>>Alta Medica o ST-2</option>
                              <option value="Prenatal" <?php echo set_select('icontrol_incapa', 'Prenatal', false, (isset($incapacidades->tipo)?$incapacidades->control_incapacidad:'0')); ?>>Prenatal</option>
                              <option value="Postnatal" <?php echo set_select('icontrol_incapa', 'Postnatal', false, (isset($incapacidades->tipo)?$incapacidades->control_incapacidad:'0')); ?>>Postnatal</option>
                              <option value="Valuacion o ST-3" <?php echo set_select('icontrol_incapa', 'Valuacion o ST-3', false, (isset($incapacidades->tipo)?$incapacidades->control_incapacidad:'0')); ?>>Valuacion o ST-3</option>
                            </select>
                          </td>
                        </tr>
                      </tbody>
