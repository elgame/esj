      ...
      <div class="row-fluid">
        <div class="box span12">
          ...
          <div class="box-content">
            <form action="<?php echo base_url('panel/compras_requisicion/'.$method); ?>" method="GET" class="form-search">
            ...
            <?php
              echo $this->usuarios_model->getLinkPrivSm('compras_requisicion/agregar/', array(
                  ...
                  <td class="center">
                    <?php
                      ...
                      if ($orden->status === 'p' && $orden->autorizado === 'f')
                      {
                        ...
                        {
                          echo $this->usuarios_model->getLinkPrivSm('compras_requisicion/modificar/', array(
                            'params'   => 'id='.$orden->id_requisicion.'&mod=t'.'&w='.($requisicion ? 'r' : 'c'),
                            'btn_type' => 'btn-info',
                            'attrs' => array())
                          );
                        }
