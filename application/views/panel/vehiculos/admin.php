			...
			<div class="row-fluid">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-truck"></i> Vehiculos</h2>
						<div class="box-icon">
							<a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
						</div>
					</div>
					<div class="box-content">
						<form action="<?php echo base_url('panel/vehiculos/'); ?>" method="get" class="form-search">
							<fieldset>
						...
						<table class="table table-striped table-bordered bootstrap-datatable">
						  ...
						  <tbody>
						<?php foreach($vehiculos['vehiculos'] as $vehiculo){ ?>
							<tr>
								...
								<td class="center">
										...
										if ($vehiculo->status == 't') {
											echo $this->usuarios_model->getLinkPrivSm('vehiculos/eliminar/', array(
													'params'   => 'id='.$vehiculo->id_vehiculo,
													'btn_type' => 'btn-danger',
													'attrs' => array('onclick' => "msb.confirm('Estas seguro de eliminar el vehiculo?', 'vehiculos', this); return false;"))
											);
										}else{
											echo $this->usuarios_model->getLinkPrivSm('vehiculos/activar/', array(
													'params'   => 'id='.$vehiculo->id_vehiculo,
													'btn_type' => 'btn-danger',
