  ...
  <div class="row-fluid">
    <div class="box span12">
      ...
      <div class="box-content">
        ...
        <form class="form-horizontal" action="<?php echo base_url('panel/compras/agregar_nota_credito/?'.String::getVarsLink(array('msg'))); ?>" method="POST" id="form" enctype="multipart/form-data">
