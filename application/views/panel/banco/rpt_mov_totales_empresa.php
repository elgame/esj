      ...
      <div class="row-fluid">
        <div class="box span12">
          <div class="box-content">
            <form action="<?php echo base_url('panel/banco/rpt_mov_totales_empresa_pdf/'); ?>" method="GET" id="frmverform" class="form-search" target="rdeReporte">
    ...
    <div id="content" class="span9">
      ...
      <div class="row-fluid">
        <div class="box span12">
          <div class="box-content">
            <a href="<?php echo base_url('panel/banco/rpt_mov_totales_empresa_xls/'); ?>" id="linkDownXls" data-url="<?php echo base_url('panel/banco/rpt_mov_totales_empresa_xls/'); ?>" class="linksm" target="_blank">
              <i class="icon-table"></i> Excel</a>
            <div class="row-fluid">
              <iframe name="rdeReporte" id="rdeReporte" class="span12"
                src="<?php echo base_url('panel/banco/rpt_mov_totales_empresa_pdf/')?>" style="height:520px;"></iframe>
            </div>
          </div>
        </div><!--/span-->
      </div><!--/row-->
