		<div id="content" class="span10">
			...
			<div class="row-fluid">
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <select name="ftipo" id="ftipo" required>
                      <option value="M.N." <?php echo set_select('ftipo', 'M.N.'); ?>>M.N.</option>
                      <option value="USD" <?php echo set_select('ftipo', 'USD'); ?>>USD</option>
                      <option value="EURO" <?php echo set_select('ftipo', 'EURO'); ?>>EURO</option>
                    </select>
                  </div>
                </div>
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="checkbox" name="fes_concentradora" id="fes_concentradora" value="si" <?php echo set_checkbox('fes_concentradora'); ?> data-uniform="false">
                  </div>
                </div>
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="checkbox" name="fcuenta_uso" id="fcuenta_uso" value="si" <?php echo set_checkbox('fcuenta_uso'); ?> data-uniform="false">
                  </div>
                </div>
