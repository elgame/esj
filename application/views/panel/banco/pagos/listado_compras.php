            ...
            <form action="<?php echo base_url('panel/banco_pagos/'); ?>" method="post">
              ...
              ?>
                ...
                <tr>
                    ...
                    <td><?php echo $value->serie.$value->folio; ?>
                      <input type="hidden" name="id_pago[]" value="<?php echo $value->id_pago; ?>">
                    </td>
                    <td><input type="text" name="monto[]" value="<?php echo $value->monto; ?>" class="monto vpositive" required>
                      <?php echo String::formatoNumero($value->monto, 2, '$', false); ?></td>
                    <td>
                    ...
                    <td>
                      <?php echo $this->usuarios_model->getLinkPrivSm('banco_pagos/eliminar_pago/', array(
