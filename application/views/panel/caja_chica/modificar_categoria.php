  ...
  <div class="row-fluid">
    <div class="box span12">
      <div class="box-header well" data-original-title>
        <h2><i class="icon-edit"></i> Modificar categoria</h2>
        <div class="box-icon">
      ...
      <div class="box-content">
        ...
        <form class="form-horizontal" action="<?php echo base_url('panel/caja_chica/categorias_modificar/?'.MyString::getVarsLink(array('msg'))); ?>" method="POST" id="form">
          ...
          <div class="row-fluid">
            <div class="span6">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <div class="input-append span12">
                    <input type="text" name="abreviatura" class="span11" id="abreviatura" value="<?php echo set_value('abreviatura', $categoria['info'][0]->abreviatura) ?>" maxlength="20" required>
                  </div>
                </div>
              </div><!--/control-group -->
