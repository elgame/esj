                              ...
                              if (isset($_POST['remision_concepto'])) {
                                ...
                                ?>
                                  <tr>
                                    ...
                                    <td style=""><input type="text" name="remision_importe[]" value="<?php echo $_POST['remision_importe'][$key] ?>" class="remision-importe vpositive " placeholder="Importe" required <?php echo $readonly ?>></td>
                                    <td style="width: 30px;">
                            ...
                            <table class="table table-striped table-bordered table-hover table-condensed" id="table-pregastos">
                              ...
                              <tbody>
                                <?php
                                  ...
                                  // $totalGastos = 0;
                                  if (count($caja['pregastos']) == 0 && isset($_POST['pregasto_concepto']) && count($_POST['pregasto_concepto']) > 0) {
                                    foreach ($_POST['pregasto_concepto'] as $key => $concepto) {
                                      // $totalGastos += floatval($_POST['gasto_importe'][$key]); ?>
                                        <tr>
                                          <td style="">
                                            <input type="hidden" name="pregasto_id_gasto[]" value="" id="gasto_id_gasto">
                                            <input type="hidden" name="pregasto_del[]" value="" id="gasto_del">
                                            <input type="text" name="pregasto_codigoArea[]" value="<?php echo $_POST['pregasto_codigoArea'][$key] ?>" id="codigoArea" class="span12 showCodigoAreaAuto" required>
                                            <input type="hidden" name="pregasto_codigoAreaId[]" value="<?php echo $_POST['pregasto_codigoAreaId'][$key] ?>" id="codigoAreaId" class="span12" required>
                                            <input type="hidden" name="pregasto_codigoCampo[]" value="<?php echo $_POST['pregasto_codigoCampo'][$key] ?>" id="codigoCampo" class="span12">
                                            <i class="ico icon-list showCodigoArea" style="cursor:pointer"></i>
                                            <input type="hidden" name="pregasto_area[]" value="<?php echo $_POST['pregasto_area'][$key] ?>" class="area span12">
                                            <input type="hidden" name="pregasto_areaId[]" value="<?php echo $_POST['pregasto_areaId'][$key] ?>" class="areaId span12">
                                            <input type="hidden" name="pregasto_rancho[]" value="<?php echo $_POST['pregasto_rancho'][$key] ?>" class="rancho span12">
                                            <input type="hidden" name="pregasto_ranchoId[]" value="<?php echo $_POST['pregasto_ranchoId'][$key] ?>" class="ranchoId span12">
                                            <input type="hidden" name="pregasto_centroCosto[]" value="<?php echo $_POST['pregasto_centroCosto'][$key] ?>" class="centroCosto span12">
                                            <input type="hidden" name="pregasto_centroCostoId[]" value="<?php echo $_POST['pregasto_centroCostoId'][$key] ?>" class="centroCostoId span12">
                                            <input type="hidden" name="pregasto_activos[]" value="<?php echo $_POST['pregasto_activos'][$key] ?>" class="activos span12">
                                            <input type="hidden" name="pregasto_activoId[]" value="<?php echo $_POST['pregasto_activoId'][$key] ?>" class="activoId span12">
                                            <input type="hidden" name="pregasto_empresaId[]" value="<?php echo $_POST['pregasto_empresaId'][$key] ?>" class="empresaId span12">
                                          </td>
                                          <td style="">
                                            <input type="text" name="pregasto_empresa[]" value="<?php echo $_POST['pregasto_empresa'][$key] ?>" class="span12 gasto-cargo" required <?php echo $readonly ?>>
                                            <input type="hidden" name="pregasto_empresa_id[]" value="<?php echo $_POST['pregasto_empresa_id'][$key] ?>" class="vpositive gasto-cargo-id">
                                          </td>
                                          <td style="">
                                            <select name="pregasto_nomenclatura[]" class="span12 ingreso_nomenclatura" <?php echo $readonly ?>>
                                              <?php foreach ($nomenclaturas as $n) { ?>
                                                <?php if ($n->tipo === 'f'): ?>
                                                <option value="<?php echo $n->id ?>" <?php echo $_POST['pregasto_nomenclatura'][$key] == $n->id ? 'selected' : '' ?>><?php echo $n->nomenclatura ?></option>
                                                <?php endif ?>
                                              <?php } ?>
                                            </select>
                                          </td>
                                          <!-- <td style=""><input type="text" name="pregasto_folio[]" value="<?php echo $_POST['gasto_folio'][$key] ?>" class="span12 gasto-folio" <?php echo $readonly ?>></td> -->
                                          <td style="">
                                            <input type="text" name="pregasto_nombre[]" value="<?php echo $_POST['pregasto_nombre'][$key] ?>" class="span12 gasto-nombre"  <?php echo $readonly ?>>
                                          </td>
                                          <td style="">
                                            <input type="text" name="pregasto_concepto[]" value="<?php echo $_POST['pregasto_concepto'][$key] ?>" class="span12 gasto-concepto"  <?php echo $readonly ?>>
                                          </td>
                                          <td style="">
                                            <input type="checkbox" value="si" class="gasto-reposicion" <?php echo $readonly; ?>>
                                            <input type="hidden" name="pregasto_reposicion[]" value="<?php echo $_POST['pregasto_reposicion'][$key] ?>" class="gasto-reposicionhid">
                                          </td>
                                          <td style=""><input type="text" name="pregasto_importe[]" value="<?php echo $_POST['pregasto_importe'][$key] ?>" class="span12 vpositive gasto-importe" <?php echo $readonly ?>></td>
                                          <td style="">
                                ...
                                <?php }} else {
                                  ...
                                  <tr>
                                    <td style="">
                                      <input type="hidden" name="pregasto_id_gasto[]" value="<?php echo $gasto->id_gasto ?>" id="gasto_id_gasto">
                                      <input type="hidden" name="pregasto_del[]" value="" id="gasto_del">
                                      <input type="text" name="pregasto_codigoArea[]" value="<?php echo $gasto->nombre_codigo ?>" id="codigoArea" class="span12 showCodigoAreaAuto" required <?php echo $readonly.$mod_gas_readonly ?>>
                                      <input type="hidden" name="pregasto_codigoAreaId[]" value="<?php echo $gasto->id_area ?>" id="codigoAreaId" class="span12" required>
                                      <input type="hidden" name="pregasto_codigoCampo[]" value="<?php echo $gasto->campo ?>" id="codigoCampo" class="span12">
                                      <i class="ico icon-list showCodigoArea" style="cursor:pointer"></i>
                                      <input type="hidden" name="pregasto_area[]" value="<?php echo $gasto->area ?>" class="area span12">
                                      <input type="hidden" name="pregasto_areaId[]" value="<?php echo $gasto->id_areac ?>" class="areaId span12">
                                      <input type="hidden" name="pregasto_rancho[]" value="<?php echo $gasto->rancho ?>" class="rancho span12">
                                      <input type="hidden" name="pregasto_ranchoId[]" value="<?php echo $gasto->id_rancho ?>" class="ranchoId span12">
                                      <input type="hidden" name="pregasto_centroCosto[]" value="<?php echo $gasto->centro_costo ?>" class="centroCosto span12">
                                      <input type="hidden" name="pregasto_centroCostoId[]" value="<?php echo $gasto->id_centro_costo ?>" class="centroCostoId span12">
                                      <input type="hidden" name="pregasto_activos[]" value="<?php echo $gasto->activo ?>" class="activos span12">
                                      <input type="hidden" name="pregasto_activoId[]" value="<?php echo $gasto->id_activo ?>" class="activoId span12">
                                      <input type="hidden" name="pregasto_empresaId[]" value="<?php echo $gasto->id_empresa ?>" class="empresaId span12">
                                      <!-- <a href="<?php echo base_url('panel/caja_chica/print_vale/?id='.$gasto->id_gasto)?>" target="_blank" title="Imprimir VALE DE CAJA CHICA">
                                        <i class="ico icon-print" style="cursor:pointer"></i></a> -->
                                    </td>
                                    <td style="">
                                      <input type="text" name="pregasto_empresa[]" value="<?php echo $gasto->empresa ?>" class="span12 gasto-cargo" required <?php echo $readonly.$mod_gas_readonly ?>>
                                      <input type="hidden" name="pregasto_empresa_id[]" value="<?php echo $gasto->id_categoria ?>" class=" vpositive gasto-cargo-id">
                                    </td>
                                    <td style="">
                                      <select name="pregasto_nomenclatura[]" class="span12 ingreso_nomenclatura" <?php echo $readonly.$mod_gas_readonly ?>>
                                        <?php foreach ($nomenclaturas as $n) { ?>
                                          <?php if ($n->tipo === 'f'): ?>
                                    ...
                                    <!-- <td style=""><input type="text" name="pregasto_folio[]" value="<?php echo $gasto->folio ?>" class="span12 gasto-folio" <?php echo $readonly.$mod_gas_readonly ?>></td> -->
                                    <td style="">
                                      <input type="text" name="pregasto_nombre[]" value="<?php echo $gasto->nombre ?>" class="span12 gasto-nombre" <?php echo $readonly.$mod_gas_readonly ?>>
                                    </td>
                                    <td style="">
                                      <input type="text" name="pregasto_concepto[]" value="<?php echo $gasto->concepto ?>" class="span12 gasto-concepto" <?php echo $readonly.$mod_gas_readonly ?>>
                                    </td>
                                    <td style="">
                                      <input type="checkbox" value="si" class="gasto-reposicion" <?php echo ($gasto->reposicion=='t'? 'checked ': ' ').$readonly.$mod_gas_readonly; ?>>
                                      <input type="hidden" name="pregasto_reposicion[]" value="<?php echo $gasto->reposicion ?>" class="gasto-reposicionhid">
                                    </td>
                                    <td style=""><input type="text" name="pregasto_importe[]" value="<?php echo $gasto->monto ?>" class="span12 vpositive gasto-importe" <?php echo $readonly.$mod_gas_readonly.$readonlyCC ?>></td>
                                    <td style="">
                                ...
                                <tr class="row-total">
                                  ...
                                  <td colspan="2">
                                    <!-- <input type="text" value="<?php echo $totalGastos ?>" class="vpositive" id="ttotal-gastos" style="text-align: right;" readonly> -->
                                  </td>
                                  <td></td>
                                </tr>
                              </tbody>
