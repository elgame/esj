        ...
        <div class="box span12">
          <div class="box-content">
            <form action="<?php echo base_url('panel/caja_chica/cargar/'); ?>" method="GET" id="form-search" class="form-search" target="rdeReporte">
              ...
              <input type="hidden" name="fno_caja" value="6">
    ...
    <div id="content" class="span12">
      ...
      <div class="row-fluid">
        <div class="box span12">
          <div class="box-content">
            <div class="row-fluid">
              <iframe name="rdeReporte" id="iframe-reporte" class="span12" src="<?php echo base_url('panel/caja_chica/cargar/?fno_caja=6')?>" style="height:600px;"></iframe>
            </div>
          </div>
        </div><!--/span-->
      </div><!--/row-->
