        ...
        <div class="row-fluid">
          <div class="box span12">
            ...
            <div class="box-content">
              ...
              <form class="form-horizontal" action="<?php echo base_url('panel/compras_ordenes/ligar/?'.MyString::getVarsLink(array('msg', 'rel'))); ?>" method="POST" id="form" enctype="multipart/form-data">
                      ...
                      <div class="row-fluid">
                        <div class="span12 mquit">
                          <table class="table table-striped table-bordered table-hover table-condensed" id="table-productos">
                            ...
                            <tbody>
                                  <?php
                                        $retencion_isr = $subtotal = $iva = $ieps = $total = $retencion = 0;
                                       ...
                                       <tr>
                                        <td style="width:15px;"><input type="checkbox" class="chkproducto" name="productoCom[]" value="<?php echo $prod->id_orden.'|'.$prod->num_row ?>" checked data-uniform="false"></td>
                                         ...
                                         <td style="width: 66px;">
                                             <!-- <input type="text" name="retIsrTotal[]" value="<?php echo isset($_POST['retIsrTotal'][$key]) ? $_POST['retIsrTotal'][$key]: $prod->retencion_isr ?>" id="retIsrTotal" class="span12" readonly> -->
                                             <input type="text" name="ret_isrPorcent[]" value="<?php echo isset($_POST['ret_isrPorcent'][$key]) ? $_POST['ret_isrPorcent'][$key]: $prod->porcentaje_isr ?>" id="ret_isrPorcent" class="span12 vpositive">
                                             <input type="hidden" name="ret_isrTotal[]" value="<?php echo isset($_POST['ret_isrTotal'][$key]) ? $_POST['ret_isrTotal'][$key]: $prod->retencion_isr ?>" id="ret_isrTotal" class="span12">
                                         </td>
                                         <td style="">
                                             <span><?php echo MyString::formatoNumero(isset($_POST['importe'][$key]) ? $_POST['importe'][$key] : $prod->importe) ?></span>
                  ...
                  <div class="span12">
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>RET ISR</td>
                          <td id="retencionisr-format"><?php echo MyString::formatoNumero(set_value('totalRetencionIsr', $retencion_isr))?></td>
                          <input type="hidden" name="totalRetencionIsr" id="totalRetencionIsr" value="<?php echo set_value('totalRetencionIsr', $retencion_isr); ?>">
                        </tr>
