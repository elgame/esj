          ...
          <div class="box-content">
            ...
            $total_saldo_cambio = 0;
                ...
                $total_saldo_cambio += $cuenta->saldo_cambio;
                  ...
                  <td style="text-align: right;" class="sel_abonom" data-id="<?php echo $cuenta->id_factura; ?>" data-tipo="<?php echo $cuenta->tipo ?>"><?php echo MyString::formatoNumero($cuenta->saldo, 2, '$', false); ?></td>
                  ...
                  <td style="text-align: right;"><?php echo MyString::formatoNumero($total_cargo-$total_abono, 2, '$', false); ?></td>
