          ...
          <div class="row-fluid">
            <div class="span12">
              ...
              <div class="control-group" style="display: <?php echo (isset($_GET['total']{0})? 'none': 'block'); ?>">
                ...
                <div class="controls">
                  <input type="number" step="any" name="dmonto" class="span8 vpositive" id="dmonto" value="<?php echo set_value('dmonto', $data['saldo']); ?>" data-max="<?php echo $data['saldo'] ?>">
                </div>
              </div>
            ...
            <div class="span11" id="abonomasivo">
              ...
              ?>
                <tr>
                  ...
                  <td><input type="number" step="any" name="montofv[]" class="monto_factura" value="<?php echo $value['saldo'] ?>" data-max="<?php echo $value['saldo'] ?>"></td>
                  <td>
                    <select name="saldar[]">
