      ...
      <div class="row-fluid">
        <div class="box span12">
          <div class="box-content">
            <form action="<?php echo base_url('panel/devoluciones_iva/rpt_ieps_ventas_pdf/'); ?>" method="GET" class="form-search" id="frmrptcproform" target="frame_reporte">
              <div class="form-actions form-filters">
                ...
                <div class="control-group">
                  <label class="control-label" for="dcliente">Clientes</label>
                  <div class="controls">
                    <div class="input-append span12">
                      <input type="text" name="dcliente" value="" id="dcliente" class="span9" placeholder="Buscar">
                      <button class="btn" type="button" id="btnAddCliente" style="margin-left:-3px;"><i class="icon-plus-sign"></i></button>
    ...
    <div id="content" class="span9">
      ...
      <div class="row-fluid">
        <div class="box span12">
          <a href="" id="linkDownXls" data-url="<?php echo base_url('panel/devoluciones_iva/rpt_ieps_ventas_xls'); ?>" class="linksm" target="_blank">
            <i class="icon-table"></i> Excel</a>

          <div class="box-content">
            <div class="row-fluid">
              <iframe id="frame_reporte" name="frame_reporte" src="<?php echo base_url('panel/devoluciones_iva/rpt_ieps_ventas_pdf/'); ?>" style="width: 100%;height: 475px;"></iframe>
            </div>
          </div>
        </div><!--/span-->
      </div><!--/row-->
