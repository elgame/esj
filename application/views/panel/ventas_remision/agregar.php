    ...
    <?php } ?>
        ...
        <form class="form-horizontal" action="<?php echo base_url('panel/ventas/agregar/'.$getId.(isset($_GET['id_nr'])? '?id_nr='.$_GET['id_nr']:'')); ?>" method="POST" id="form">
          ...
          <div id="myTabContent" class="tab-content">
            ...
            <div class="tab-pane active" id="tabRemision">
              ...
              <div id="modal-certificado1603" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-header">
                  <!-- <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button> -->
                  <h3 id="myModalLabel">Informacion Certificado</h3>
                  <button type="button" class="btn pull-right" id="btn_certificado1603_add"><i class="icon-plus"></i></button>
                </div>
                <div class="modal-body">
                  <?php
                  if (isset($borrador) && isset($borrador['certificado1603'])){
                    foreach ($borrador['certificado1603'] as $sp => $prodesp) {
                      $_POST['pproveedor_certificado1603'][] = $prodesp->proveedor;
                      $_POST['cert_id_proveedor1603'][]      = $prodesp->id_proveedor;
                      $_POST['cert_certificado1603'][]       = $prodesp->certificado;
                      $_POST['cert_bultos1603'][]            = $prodesp->bultos;
                      $_POST['cert_num_operacion1603'][]     = $prodesp->num_operacion;
                      $_POST['cert_no_certificado1603'][]    = $prodesp->no_certificado;
                      $_POST['cert_id_orden1603'][]          = $prodesp->id_orden;
                    }
                  }

                  if (isset($_POST['cert_id_proveedor1603']) && count($_POST['cert_id_proveedor1603']) > 0) {
                    foreach ($_POST['cert_id_proveedor1603'] as $key => $value) {
                  ?>
                  <div class="grup_datos" style="border-bottom: 2px solid #aaa;">
                    <div class="control-group">
                      <label class="control-label" for="pproveedor_certificado1603" style="width: auto;">PROVEEDOR</label>
                      <div class="controls" style="margin-left: 0">
                        <input type="text" name="pproveedor_certificado1603[]" value="<?php echo $_POST['pproveedor_certificado1603'][$key]; ?>" id="pproveedor_certificado1603" class="span12 sikey field-check pproveedor_certificado1603" placeholder="Proveedor" data-next="cert_certificado1603">
                        <input type="hidden" name="cert_id_proveedor1603[]" value="<?php echo $_POST['cert_id_proveedor1603'][$key]; ?>" id="cert_id_proveedor1603" class="field-check">
                      </div>
                    </div>
                    <div class="control-group">
                      <label class="control-label" for="cert_certificado1603" style="width: auto;">CERTIFICADO</label>
                      <div class="controls" style="margin-left: 0">
                        <input type="text" name="cert_certificado1603[]" class="span12 sikey field-check" id="cert_certificado1603" value="<?php echo $_POST['cert_certificado1603'][$key]; ?>" maxlength="30" placeholder="Certificado" data-next="cert_bultos1603">
                      </div>
                    </div>
                    <div class="control-group">
                      <label class="control-label" for="cert_bultos1603" style="width: auto;">BULTOS</label>
                      <div class="controls" style="margin-left: 0">
                        <input type="text" name="cert_bultos1603[]" class="span12 vpositive sikey field-check" id="cert_bultos1603" value="<?php echo $_POST['cert_bultos1603'][$key]; ?>" placeholder="Bultos" data-next="cert_num_operacion1603">
                      </div>
                    </div>
                    <div class="control-group">
                      <label class="control-label" for="cert_num_operacion1603" style="width: auto;">Num Operacion</label>
                      <div class="controls" style="margin-left: 0">
                        <input type="text" name="cert_num_operacion1603[]" class="span12 sikey field-check" id="cert_num_operacion1603" value="<?php echo $_POST['cert_num_operacion1603'][$key] ?>" placeholder="Num Operacion" data-next="pproveedor_certificado1603">
                      </div>
                    </div>
                    <div class="control-group">
                      <label class="control-label" for="cert_no_certificado1603" style="width: auto;">Certificado de compra</label>
                      <div class="controls" style="margin-left: 0">
                        <input type="text" name="cert_no_certificado1603[]" class="span12 sikey cursorp cert_no_certificado1603" id="cert_no_certificado1603" value="<?php echo $_POST['cert_no_certificado1603'][$key] ?>" placeholder="Num Certificado" data-next="pproveedor_certificado1603" readonly>
                        <input type="hidden" name="cert_id_orden1603[]" class="span12 sikey" id="cert_id_orden1603" value="<?php echo $_POST['cert_id_orden1603'][$key] ?>">
                      </div>
                    </div>
                  </div>
                <?php }
                  ...
                  <div class="grup_datos" style="border-bottom: 2px solid #aaa;">
                    <div class="control-group">
                      <label class="control-label" for="pproveedor_certificado1603" style="width: auto;">PROVEEDOR</label>
                      <div class="controls" style="margin-left: 0">
                        <input type="text" name="pproveedor_certificado1603[]" value="<?php echo set_value('pproveedor_certificado1603[]', isset($borrador) && isset($borrador['certificado1603']) ? $borrador['certificado1603']->proveedor : '') ?>" id="pproveedor_certificado1603" class="span12 sikey field-check pproveedor_certificado1603" placeholder="Proveedor" data-next="cert_certificado1603">
                        <input type="hidden" name="cert_id_proveedor1603[]" value="<?php echo set_value('cert_id_proveedor1603[]', isset($borrador) && isset($borrador['certificado1603']) ? $borrador['certificado1603']->id_proveedor : '') ?>" id="cert_id_proveedor1603" class="field-check">
                      </div>
                    </div>
                    <div class="control-group">
                      <label class="control-label" for="cert_certificado1603" style="width: auto;">CERTIFICADO</label>
                      <div class="controls" style="margin-left: 0">
                        <input type="text" name="cert_certificado1603[]" class="span12 sikey field-check" id="cert_certificado1603" value="<?php echo set_value('cert_certificado1603[]', isset($borrador) && isset($borrador['certificado1603']) ? $borrador['certificado1603']->certificado : ''); ?>" maxlength="30" placeholder="Certificado" data-next="cert_bultos1603">
                      </div>
                    </div>
                    <div class="control-group">
                      <label class="control-label" for="cert_bultos1603" style="width: auto;">BULTOS</label>
                      <div class="controls" style="margin-left: 0">
                        <input type="text" name="cert_bultos1603[]" class="span12 vpositive sikey field-check" id="cert_bultos1603" value="<?php echo set_value('cert_bultos1603[]', isset($borrador) && isset($borrador['certificado1603']) ? $borrador['certificado1603']->bultos : ''); ?>" placeholder="Bultos" data-next="cert_num_operacion1603">
                      </div>
                    </div>
                    <div class="control-group">
                      <label class="control-label" for="cert_num_operacion1603" style="width: auto;">Num Operacion</label>
                      <div class="controls" style="margin-left: 0">
                        <input type="text" name="cert_num_operacion1603[]" class="span12 sikey field-check" id="cert_num_operacion1603" value="<?php echo set_value('cert_num_operacion1603[]', isset($borrador) && isset($borrador['certificado1603']) ? $borrador['certificado1603']->num_operacion : ''); ?>" placeholder="Num Operacion" data-next="cert_no_certificado1603">
                      </div>
                    </div>
                    <div class="control-group">
                      <label class="control-label" for="cert_no_certificado1603" style="width: auto;">Certificado de compra</label>
                      <div class="controls" style="margin-left: 0">
                        <input type="text" name="cert_no_certificado1603[]" class="span12 sikey cursorp cert_no_certificado1603" id="cert_no_certificado1603" value="<?php echo set_value('cert_no_certificado1603[]', isset($borrador) && isset($borrador['certificado1603']) ? $borrador['certificado1603']->no_certificado : ''); ?>" placeholder="Num Certificado" data-next="pproveedor_certificado1603" readonly>
                        <input type="hidden" name="cert_id_orden1603[]" class="span12 sikey" id="cert_id_orden1603" value="<?php echo set_value('cert_id_orden1603[]', isset($borrador) && isset($borrador['certificado1603']) ? $borrador['certificado1603']->id_orden : ''); ?>">
                      </div>
                    </div>
                  </div>
                <?php } ?>
                ...
                <div class="modal-footer">
                  <button class="btn" data-dismiss="modal" aria-hidden="true" id="btnClose" <?php echo isset($borrador) && isset($borrador['certificado1603']) ? '' : 'disabled' ?>>Cerrar</button>
                </div>
              </div>
            ...
            <div class="tab-pane" id="tabExisLimon">
              <div class="row-fluid">

                <div class="box span6">
                  <div class="box-header well" data-original-title>
                    <h2><i class="icon-plus"></i> Comisiones a terceros</h2>
                    <div class="box-icon">
                      <a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
                    </div>
                  </div>
                      ...
                      <div class="span12" style="margin-top: 1px;">
                        <table class="table table-striped table-bordered table-hover table-condensed" id="table-comision-terceros">
                          ...
                          <tbody>
                            ...
                            <?php
                            if (isset($cajaExtLimon['comision_terceros'])) {
                              foreach ($cajaExtLimon['comision_terceros'] as $desc) {
                ...
                <div class="box span6">
                  <div class="box-header well" data-original-title>
                    <h2><i class="icon-plus"></i> Gastos Generales</h2>
                    <div class="box-icon">
                      <a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
                    </div>
                  </div>
                                  ...
                                  <table class="table table-striped table-bordered table-hover table-condensed" id="table-gastos">
                                    <thead>
                                      <tr>
                                        <th colspan="2">GASTOS GENERALES
                                          <button type="button" class="btn btn-success" id="btn-add-gasto" style="padding: 2px 7px 2px;margin-right: 2px;"><i class="icon-plus"></i></button>
                                        </th>
                                    ...
                                    <tbody>
                                      <?php
                                        ...
                                        if (isset($_POST['gasto_concepto']) && count($_POST['gasto_concepto']) > 0) {
                                      ...
                                      <?php
                                      if (isset($cajaExtLimon['gastos'])) {
                                        foreach ($cajaExtLimon['gastos'] as $gasto) {
