                          ...
                          <table class="table table-striped table-cpDomicilio">
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td class="center"><input type="text" name="cp[ubicaciones][<?php echo $count ?>][domicilio][codigoPostal]" value="<?php echo set_value('cp[ubicaciones]['.$count.'][domicilio][codigoPostal]', isset($ubic->domicilio->codigo_postal) ? $ubic->domicilio->codigo_postal : ''); ?>" class="span12 sikey" id="cp_ubic_dom_codigopostal" minlength="1" maxlength="12" data-next="cp_ubic_dom_colonia"></td>
