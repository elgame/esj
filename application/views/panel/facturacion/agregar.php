                          ...
                          <table class="table table-striped table-cpOrigen">
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td class="center">
                                  <input type="text" name="cp[ubicaciones][][origen][numEstacion_text]" value="<?php echo set_value('cp[ubicaciones][][origen][numEstacion_text]', isset($ubic->origen->numEstacion_text) ? $ubic->origen->numEstacion_text : ''); ?>" id="cp_ubic_origen_numEstacion_text" maxlength="60" class="span12 sikey" data-next="cp_ubic_origen_nombreEstacion">
                                  <input type="hidden" name="cp[ubicaciones][][origen][numEstacion]" value="<?php echo set_value('cp[ubicaciones][][origen][numEstacion]', isset($ubic->origen->numEstacion) ? $ubic->origen->numEstacion : ''); ?>" id="cp_ubic_origen_numEstacion" maxlength="60" class="span12 sikey">
                                </td>
                          ...
                          <table class="table table-striped table-cpDestino">
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td class="center">
                                  <input type="text" name="cp[ubicaciones][][destino][residenciaFiscal_text]" value="<?php echo set_value('cp[ubicaciones][][destino][residenciaFiscal_text]', isset($ubic->destino->residenciaFiscal_text) ? $ubic->destino->residenciaFiscal_text : ''); ?>" id="cp_ubic_destino_residenciaFiscal_text" maxlength="40" class="span12 sikey" data-next="cp_ubic_destino_numEstacion_text">
                                ...
                                <td class="center">
                                  <input type="text" name="cp[ubicaciones][][destino][numEstacion_text]" value="<?php echo set_value('cp[ubicaciones][][destino][numEstacion_text]', isset($ubic->destino->numEstacion_text) ? $ubic->destino->numEstacion_text : ''); ?>" id="cp_ubic_destino_numEstacion_text" maxlength="60" class="span12 sikey" data-next="cp_ubic_destino_nombreEstacion">
                                  <input type="hidden" name="cp[ubicaciones][][destino][numEstacion]" value="<?php echo set_value('cp[ubicaciones][][destino][numEstacion]', isset($ubic->destino->numEstacion) ? $ubic->destino->numEstacion : ''); ?>" id="cp_ubic_destino_numEstacion" maxlength="60" class="span12 sikey">
                                </td>
                  ...
                  <div class="row-fluid">
                    <div class="box span12">
                      <div class="box-header well">
                        ...
                        <div class="box-icon">
                          <a href="javascript:void(0);" class="btn-add" id="btn-add-CpMercancias" data-rel="tooltip" data-title="Agregar Ubicaciones"><i class="icon-plus"></i></a>
                        </div>
                      </div>
