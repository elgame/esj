      ...
      <div class="row-fluid">
        <div class="box span12">
          <div class="box-content">
            <form action="<?php echo base_url('panel/facturacion/prodfact2_pdf/'); ?>" method="GET" class="form-search" target="rpfReporte" id="form">
              <div class="form-actions form-filters">
                ...
                <div class="control-group">
                  <label class="control-label" for="dcalidad">Calidad</label>
                  <div class="controls">
                    <input type="text" name="dcalidad" class="input-xlarge search-query" id="dcalidad" value="<?php echo set_value_get('dcalidad'); ?>" size="73">
                    <input type="hidden" name="did_calidad" id="did_calidad" value="<?php echo set_value_get('did_calidad'); ?>">
                  </div>
                </div>

                <div class="control-group">
                  <label class="control-label" for="dtamanio">Tamaño</label>
                  <div class="controls">
                    <input type="text" name="dtamanio" class="input-xlarge search-query" id="dtamanio" value="<?php echo set_value_get('dtamanio'); ?>" size="73">
                    <input type="hidden" name="did_tamanio" id="did_tamanio" value="<?php echo set_value_get('did_tamanio'); ?>">
                  </div>
                </div>
    ...
    <div id="content" class="span9">
      ...
      <div class="row-fluid">
        <div class="box span12">
          <a href="" id="linkDownXls" data-url="<?php echo base_url('panel/facturacion/prodfact2_xls'); ?>" class="linksm" target="_blank">
            <i class="icon-table"></i> Excel</a>

          <div class="box-content">
            <div class="row-fluid">
              <iframe name="rpfReporte" id="iframe-reporte" class="span12"
                src="<?php echo base_url('panel/facturacion/prodfact2_pdf')?>" style="height:520px;"></iframe>
            </div>
          </div>
        </div><!--/span-->
      </div><!--/row-->
