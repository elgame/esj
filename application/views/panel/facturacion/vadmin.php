      ...
      <div class="row-fluid">
        <div class="box span12">
          ...
          <div class="box-content">
            <form action="<?php echo base_url('panel/ventas_dia/'); ?>" method="GET" class="form-search">
            ...
            <?php
            echo $this->usuarios_model->getLinkPrivSm('ventas_dia/agregar/', array(
                    'params'   => '',
                ...
                <tr>
                  ...
                  <td class="center">
                    <?php
                        ...
                        if ($fact->id_factura_asignada == '' && $fact->status !== 'ca') {
                          echo $this->usuarios_model->getLinkPrivSm('ventas_dia/modificar/', array(
                            'params'   => 'idb='.$fact->id_factura,
                            'btn_type' => 'btn-success',
                            'attrs' => array('target' => ""))
                          );
                        }

                        echo $this->usuarios_model->getLinkPrivSm('ventas_dia/imprimir/', array(
                        ...
                        if ($fact->status !== 'ca' && $fact->id_nc === null)
                        {
                          if ($fact->id_factura_asignada == '') {
                            ...
                            echo $this->usuarios_model->getLinkPrivSm('ventas_dia/cancelar/', array(
                              'params'   => 'id='.$fact->id_factura,
                              'btn_type' => 'btn-danger',
                              'attrs' => array('onclick' => "msb.confirm('Estas seguro de Cancelar la venta?<br><strong>NOTA: Esta opción no se podra revertir.</strong>', 'Facturas', this); return false;"))
                            );
                          }
