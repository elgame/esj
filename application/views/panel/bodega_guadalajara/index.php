      ...
      <div class="row-fluid center">
        <div class="box span12">
          <div class="box-content">
            <form action="<?php echo base_url('panel/bodega_guadalajara/cargar/'); ?>" method="GET" id="form-search" class="form-search" target="rdeReporte">
    ...
    <div id="content" class="span12">
      ...
      <div class="row-fluid">
        <div class="box span12">
          <div class="box-content">
            <div class="row-fluid">
              <iframe name="rdeReporte" id="iframe-reporte" class="span12" src="<?php echo base_url('panel/bodega_guadalajara/cargar/?fno_caja=1')?>" style="height:600px;"></iframe>
            </div>
          </div>
        </div><!--/span-->
      </div><!--/row-->
