      ...
      <div class="row-fluid">
        <div class="box span12">
          <div class="box-content">
            <form action="<?php echo base_url('panel/bodega_guadalajara/rpt_gastos_pdf/'); ?>" method="GET" class="form-search" id="frmverformprod" target="frame_reporte">
    ...
    <div id="content" class="span9">
      ...
      <a href="<?php echo base_url('panel/bodega_guadalajara/rpt_gastos_xls/'); ?>" id="linkDownXls" data-url="<?php echo base_url('panel/bodega_guadalajara/rpt_gastos_xls/'); ?>" class="linksm" target="_blank">
            <i class="icon-table"></i> Excel</a>
      <iframe id="frame_reporte" name="frame_reporte" src="<?php echo base_url('panel/bodega_guadalajara/rpt_gastos_pdf/'); ?>" style="width: 100%;height: 475px;"></iframe>
