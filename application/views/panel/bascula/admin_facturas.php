      ...
      <div class="row-fluid">
        <div class="box span12">
          ...
          <div class="box-content">
            <form action="<?php echo base_url('panel/bascula/facturas/'); ?>" method="GET" class="form-search">
            ...
            <?php foreach($compras['compras'] as $compra) {?>
                <tr>
                  ...
                  <td class="center">
                    <?php
                      echo $this->usuarios_model->getLinkPrivSm('bascula/facturas_ver/', array(
                        'params'   => 'id='.$compra->id_factura.'&idp='.$compra->id_proveedor,
                      ...
                      if ($compra->status !== 'ca')
                      {
                        echo $this->usuarios_model->getLinkPrivSm('bascula/facturas_cancelar/', array(
                          'params'   => 'id='.$compra->id_factura,
                          'btn_type' => 'btn-danger',
