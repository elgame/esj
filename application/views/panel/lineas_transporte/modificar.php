      ...
      <div class="row-fluid">
        <div class="box span12">
          <div class="box-header well" data-original-title>
            <h2><i class="icon-edit"></i> Modificar linea</h2>
            <div class="box-icon">
              <a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
            </div>
          </div>
          <div class="box-content">
            <form action="<?php echo base_url('panel/lineas_transporte/modificar/?id='.$_GET['id']); ?>" method="post" class="form-horizontal">
              <fieldset>
                <legend></legend>
                <?php
                  $data = $data['info'];
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    ...
                    value="<?php echo isset($data->nombre)?$data->nombre:''; ?>" required autofocus placeholder="Linea del Sur">
                  </div>
                </div>
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="text" name="ftelefonos" id="ftelefonos" class="span6" value="<?php echo isset($data->telefonos)?$data->telefonos:''; ?>"
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="text" name="fid" id="fid" class="span6" value="<?php echo isset($data->id)?$data->id:''; ?>"
