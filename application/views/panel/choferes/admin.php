			...
			<div class="row-fluid">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i> Choferes</h2>
						<div class="box-icon">
							<a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
						</div>
					</div>
					<div class="box-content">
						<form action="<?php echo base_url('panel/choferes/'); ?>" method="get" class="form-search">
							<fieldset>
								<legend>Filtros</legend>

								<label for="fnombre">Buscar</label>
								<input type="text" name="fnombre" id="fnombre" value="<?php echo set_value_get('fnombre'); ?>" 
									class="input-large search-query" placeholder="Raul, Jose Torres" autofocus> |
						...
						<?php 
						echo $this->usuarios_model->getLinkPrivSm('choferes/agregar/', array(
										'params'   => '',
						...
						<?php foreach($choferes['choferes'] as $chofer){ ?>
							<tr>
								...
								<td class="center">
										<?php 
										echo $this->usuarios_model->getLinkPrivSm('choferes/modificar/', array(
												'params'   => 'id='.$chofer->id_chofer,
												'btn_type' => 'btn-success')
										);
										if ($chofer->status == 't') {
											echo $this->usuarios_model->getLinkPrivSm('choferes/eliminar/', array(
													'params'   => 'id='.$chofer->id_chofer,
													'btn_type' => 'btn-danger',
													'attrs' => array('onclick' => "msb.confirm('Estas seguro de eliminar el chofer?', 'choferes', this); return false;"))
											);
										}else{
											echo $this->usuarios_model->getLinkPrivSm('choferes/activar/', array(
													'params'   => 'id='.$chofer->id_chofer,
													'btn_type' => 'btn-danger',
													'attrs' => array('onclick' => "msb.confirm('Estas seguro de activar el chofer?', 'choferes', this); return false;"))
											);
										}
					...
					<?php }?>
					  ...
					  <?php
						...
						$this->pagination->initialize(array(
								...
								'total_rows'		=> $choferes['total_rows'],
								'per_page'			=> $choferes['items_per_page'],
								'cur_page'			=> $choferes['result_page']*$choferes['items_per_page'],
