...
class notas_credito extends MY_Controller {
  /**
   * Evita la validacion (enfocado cuando se usa ajax). Ver mas en privilegios_model
   * @var unknown_type
   */
  private $excepcion_privilegio = array(
    'notas_credito/ajax_get_series_folio/',
    'notas_credito/ajax_get_folio/',
  );
  ...
  public function agregar()
  {
    if (isset($_GET['id']{0}))
    {
      ...
      $this->load->view('panel/notas_credito/agregar', $params);
  ...
  public function ajax_get_series_folio()
  {
    ...
    {
      $this->load->model('facturacion_model');
      $res = $this->facturacion_model->getSeriesEmpresa($_GET['ide'], "es_nota_credito = 't'");
  ...
  public function ajax_get_folio()
  {
    ...
    {
      $this->load->model('facturacion_model');
      $res = $this->facturacion_model->getFolioSerie($_GET['serie'], $_GET['ide'], "es_nota_credito = 't'");
