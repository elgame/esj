...
class compras_requisicion extends MY_Controller {
  ...
  public function configAddOrden()
  {
    ...
    $rules = array(
      ...
      array('field' => 'codigo1[]',
            'label' => '',
            'rules' => ''),
      array('field' => 'tipo_cambio1[]',
            'label' => '',
            'rules' => ''),
      array('field' => 'concepto1[]',
            'label' => '',
            'rules' => ''),
      array('field' => 'productoId1[]',
            'label' => '',
            'rules' => ''),
      array('field' => 'presentacion1[]',
            'label' => '',
            'rules' => ''),
      array('field' => 'presentacionName1[]',
            'label' => '',
            'rules' => ''),
      array('field' => 'unidad1[]',
            'label' => '',
            'rules' => ''),
      array('field' => 'cantidad1[]',
            'label' => '',
            'rules' => ''),
      array('field' => 'faltantes1[]',
            'label' => '',
            'rules' => ''),
      ...
      array('field' => 'trasladoTotal1[]',
            'label' => '',
            'rules' => ''),
      array('field' => 'trasladoPorcent1[]',
            'label' => '',
            'rules' => ''),
      array('field' => 'iepsTotal1[]',
            'label' => '',
            'rules' => ''),
      array('field' => 'iepsPorcent1[]',
            'label' => '',
            'rules' => ''),
      ...
      array('field' => 'codigo2[]',
            'label' => '',
            'rules' => ''),
      array('field' => 'tipo_cambio2[]',
            'label' => '',
            'rules' => ''),
      array('field' => 'concepto2[]',
            'label' => '',
            'rules' => ''),
      array('field' => 'productoId2[]',
            'label' => '',
            'rules' => ''),
      array('field' => 'presentacion2[]',
            'label' => '',
            'rules' => ''),
      array('field' => 'presentacionName2[]',
            'label' => '',
            'rules' => ''),
      array('field' => 'unidad2[]',
            'label' => '',
            'rules' => ''),
      array('field' => 'cantidad2[]',
            'label' => '',
            'rules' => ''),
      array('field' => 'faltantes2[]',
            'label' => '',
            'rules' => ''),
      ...
      array('field' => 'trasladoTotal2[]',
            'label' => '',
            'rules' => ''),
      array('field' => 'trasladoPorcent2[]',
            'label' => '',
            'rules' => ''),
      array('field' => 'iepsTotal2[]',
            'label' => '',
            'rules' => ''),
      array('field' => 'iepsPorcent2[]',
            'label' => '',
            'rules' => ''),
      ...
      array('field' => 'codigo3[]',
            'label' => '',
            'rules' => ''),
      array('field' => 'tipo_cambio3[]',
            'label' => '',
            'rules' => ''),
      array('field' => 'concepto3[]',
            'label' => '',
            'rules' => ''),
      array('field' => 'productoId3[]',
            'label' => '',
            'rules' => ''),
      array('field' => 'presentacion3[]',
            'label' => '',
            'rules' => ''),
      array('field' => 'presentacionName3[]',
            'label' => '',
            'rules' => ''),
      array('field' => 'unidad3[]',
            'label' => '',
            'rules' => ''),
      array('field' => 'cantidad3[]',
            'label' => '',
            'rules' => ''),
      array('field' => 'faltantes3[]',
            'label' => '',
            'rules' => ''),
      ...
      array('field' => 'trasladoTotal3[]',
            'label' => '',
            'rules' => ''),
      array('field' => 'trasladoPorcent3[]',
            'label' => '',
            'rules' => ''),
      array('field' => 'iepsTotal3[]',
            'label' => '',
            'rules' => ''),
      array('field' => 'iepsPorcent3[]',
            'label' => '',
            'rules' => ''),
  ...
  {
    if ($this->input->post('proveedorId1') == '' && isset($_POST['concepto1']) && count($_POST['concepto1']) > 0 )
    {
      $this->form_validation->set_message('val_proveedor2', 'Se tiene que seleccionar el proveedor 1.');
      return false;
    }elseif ($this->input->post('proveedorId2') == '' && isset($_POST['concepto2']) && count($_POST['concepto2']) > 0 )
    {
      $this->form_validation->set_message('val_proveedor2', 'Se tiene que seleccionar el proveedor 2.');
      return false;
    }elseif ($this->input->post('proveedorId3') == '' && isset($_POST['concepto3']) && count($_POST['concepto3']) > 0 )
    {
