...
class empleadosr extends MY_Controller {
  ...
  public function index()
  {
    ...
    $this->load->model('empresas_model');
		...
		$params['usuarios'] = $this->usuarios_model->get_usuarios(true, 't', 'l');
    $params['empresa'] = $this->empresas_model->getDefaultEmpresa();
		...
		$this->load->view('panel/nomina_fiscal/ranchos/empleados/admin', $params);
	...
	public function agregar()
	{
		...
		$this->load->view('panel/header', $params);
		$this->load->view('panel/general/menu', $params);
		$this->load->view('panel/nomina_fiscal/ranchos/empleados/agregar', $params);
		$this->load->view('panel/footer');
	}
	...
	public function modificar()
	{
		if (isset($_GET['id']))
		{
			...
			$this->load->view('panel/header', $params);
			$this->load->view('panel/general/menu', $params);
			$this->load->view('panel/nomina_fiscal/ranchos/empleados/modificar', $params);
			$this->load->view('panel/footer');
		}
		else
