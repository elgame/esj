...
class btrabajo_agricola extends MY_Controller {
    ...
    'btrabajo_agricola/printEntrada/',
    'btrabajo_agricola/rpt_seg_cert_pdf/',
  );
  ...
  public function index()
  {
		...
		$params['seo'] = array(
			'titulo' => 'Administración de trabajo agricola'
		);

		$this->load->model('empresas_model');
		$this->load->model('btrabajo_agricola_model');
		$params['btrabajo_agricola'] = $this->btrabajo_agricola_model->getEntradas();
		...
		$this->load->view('panel/trabajo_agricola/admin', $params);
    ...
    $params['empresa_default'] = $this->empresas_model->getDefaultEmpresa();
		...
		$this->load->view('panel/header', $params);
		$this->load->view('panel/general/menu', $params);
		$this->load->view('panel/trabajo_agricola/agregar', $params);
		$this->load->view('panel/footer');
	}
	...
	public function modificar()
	{
		if (isset($_GET['id']))
		{
			...
			$this->carabiner->js(array(
				...
				array('general/keyjump.js'),
				array('panel/otros/addmod_trabajo_agricola.js'),
			...
			$this->load->view('panel/header', $params);
			$this->load->view('panel/general/menu', $params);
			$this->load->view('panel/trabajo_agricola/modificar', $params);
			$this->load->view('panel/footer');
		}
		else
	...
	public function printEntrada()
	{
		...
		if (isset($_GET['hojas']))
		{
			$this->btrabajo_agricola_model->printHojas( $_GET['hojas'] );
		}
		else {
	    ...
	    $pdf->AddPage();
	    $x = $y = 5;
			$this->btrabajo_agricola_model->printRecibo( $_GET['id'], $pdf, $x, $y );
		...
		if ($accion == 'agregar') {
			...
			$rules = array(
				...
				array('field' => 'codigoAreaId',
							'label' => 'Vehiculo',
							'rules' => 'required'),
				array('field' => 'foperadorId',
							'label' => 'Operador',
							'rules' => 'required'),
				array('field' => 'fhorometro_ini',
							'label' => 'Horometro Ini',
							'rules' => 'required'),
				array('field' => 'fhorometro_fin',
							'label' => 'Horometro Fin',
							'rules' => 'required'),
				array('field' => 'fhorometro_total',
							'label' => 'Total Kms',
							'rules' => 'required'),
				array('field' => 'fhr_ini',
							'label' => 'Hora Ini',
				...
				array('field'	=> 'ptiempo[]',
						'label'	=> 'Clasf',
						'rules'	=> ''),
				array('field'	=> 'plaborId[]',
						'label'	=> 'Piso',
						'rules'	=> ''),
				array('field'	=> 'ccostoId[]',
						'label'	=> 'Estibas',
						'rules'	=> ''),
				array('field'	=> 'plabor[]',
						'label'	=> 'Altura',
