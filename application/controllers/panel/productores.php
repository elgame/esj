...
public function fecha($fecha)
{
  ...
  public function index()
  {
		...
		$params['seo'] = array(
			'titulo' => 'Administración de Productores'
		);
    ...
    if(!isset($_GET['did_empresa']))
		...
		$this->load->view('panel/productores/admin', $params);
  ...
  public function show_view_agregar_productor()
  {
	...
	public function ajax_get_productores(){
		$this->load->model('productores_model');
		$params = $this->productores_model->getProductorAjax();
	...
	{
		$this->load->model('productores_model');
		$this->productores_model->catalogo_xls();
	}
