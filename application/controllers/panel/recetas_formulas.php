...
class recetas_formulas extends MY_Controller {
  ...
  public function modificar()
  {
    ...
    $params['orden'] = $this->recetas_formulas_model->info($_GET['id'], true);
  ...
  public function ligar()
  {
    ...
    {
      $res_mdl = $this->recetas_formulas_model->agregarCompra($_POST['proveedorId'], $_POST['empresaId'], $_GET['ids'], $_FILES['xml']);
    ...
    {
      $orden = $this->recetas_formulas_model->info($ordenId, true, true);
  ...
  {
    $this->load->model('recetas_formulas_model');
    $this->recetas_formulas_model->imprimir_entrada($_GET['folio'], $_GET['ide']);
  }
  ...
  public function email()
  {
    ...
    $response = $this->recetas_formulas_model->email($_GET['id']);
  ...
  public function imprimir_recibo_faltantes()
  {
    ...
    if (isset($_GET['p']))
    {
      $this->recetas_formulas_model->print_recibo_faltantes($_GET['id']);
    }
    else
    {
      $this->load->view('panel/compras_ordenes/print_orden_compra');
  ...
  public function ajax_producto_by_codigo()
  {
    ...
    $producto = $this->recetas_formulas_model->getProductoByCodigoAjax($_GET['ide'], $_GET['tipo'], $_GET['cod']);
  ...
  public function ajax_producto()
  {
    ...
    $productos = $this->recetas_formulas_model->getProductoAjax($_GET['ide'], $_GET['tipo'], $where, 'nombre');
  ...
  public function ajax_get_producto_all()
  {
    ...
    $productos = $this->recetas_formulas_model->getProductoAjax(null, $_GET['tipo'], $where, 'nombre');
  ...
  {
    $this->load->model('recetas_formulas_model');
    $productos = $this->recetas_formulas_model->getFactRem($_GET);
