                         ...
                         $subsidio = null, $isr = null, $utilidadEmpresa = null, $descuentoOtros = null, $tipo = null, $extras = null)
  {
    ...
    { // nomina no guardada
      ...
      if ($nm_tipo == 'pt') { // es ptu
        $utilidadEmpresa = $utilidadEmpresa*2;
        $sql_query_nom = "SELECT u.id,
            u.no_empleado,
            (COALESCE(u.apellido_paterno, '') || ' ' || COALESCE(u.apellido_materno, '') || ' ' || u.nombre) as nombre,
            COALESCE(u.apellido_paterno, '') AS apellido_paterno, COALESCE(u.apellido_materno, '') AS apellido_materno, u.nombre AS nombre2,
      ...
      if ($datos['generar_nomina'] === '1' && $existe_nomina->num_rows() === 0)
      {
        ...
        if($datos['esta_asegurado'] == 't')
        {
          ...
          if ($empleadoNomina[0]->nomina_guardada === 'f') {
            $empleadoNomina[0]->ptu_empleado_dias = $empleadoNomina[0]->ptu_empleado_dias/2;
            $empleadoNomina[0]->ptu_empleado_percepciones = $empleadoNomina[0]->ptu_empleado_percepciones/2;
            $empleadoNomina[0]->utilidad_empresa = $empleadoNomina[0]->utilidad_empresa/2;
            $empleadoNomina[0]->utilidad_empresa_ptu = $empleadoNomina[0]->utilidad_empresa_ptu/2;

            $empleadoNomina[0]->nomina->TotalPercepciones = $empleadoNomina[0]->nomina->TotalPercepciones/2;
            $empleadoNomina[0]->nomina->TotalDeducciones = $empleadoNomina[0]->nomina->TotalDeducciones/2;
            $empleadoNomina[0]->nomina->TotalOtrosPagos = $empleadoNomina[0]->nomina->TotalOtrosPagos/2;
            $empleadoNomina[0]->nomina->subtotal = $empleadoNomina[0]->nomina->subtotal/2;
            $empleadoNomina[0]->nomina->descuento = $empleadoNomina[0]->nomina->descuento/2;
            $empleadoNomina[0]->nomina->isr = $empleadoNomina[0]->nomina->isr/2;

            $empleadoNomina[0]->nomina->percepciones['ptu']['ImporteGravado'] = $empleadoNomina[0]->nomina->percepciones['ptu']['ImporteGravado']/2;
            $empleadoNomina[0]->nomina->percepciones['ptu']['ImporteExcento'] = $empleadoNomina[0]->nomina->percepciones['ptu']['ImporteExcento']/2;
            $empleadoNomina[0]->nomina->percepciones['ptu']['total'] = $empleadoNomina[0]->nomina->percepciones['ptu']['total']/2;

            $empleadoNomina[0]->nomina->deducciones['isr']['ImporteGravado'] = $empleadoNomina[0]->nomina->deducciones['isr']['ImporteGravado']/2;
            $empleadoNomina[0]->nomina->deducciones['isr']['ImporteExcento'] = $empleadoNomina[0]->nomina->deducciones['isr']['ImporteExcento']/2;
            $empleadoNomina[0]->nomina->deducciones['isr']['total'] = $empleadoNomina[0]->nomina->deducciones['isr']['total']/2;

            $empleadoNomina[0]->nomina->deduccionesTotales['TotalOtrasDeducciones'] = $empleadoNomina[0]->nomina->deduccionesTotales['TotalOtrasDeducciones']/2;
            $empleadoNomina[0]->nomina->deduccionesTotales['TotalImpuestosRetenidos'] = $empleadoNomina[0]->nomina->deduccionesTotales['TotalImpuestosRetenidos']/2;

            $empleadoNomina[0]->nomina->percepcionesTotales['TotalGravado'] = $empleadoNomina[0]->nomina->percepcionesTotales['TotalGravado']/2;
            $empleadoNomina[0]->nomina->percepcionesTotales['TotalExento'] = $empleadoNomina[0]->nomina->percepcionesTotales['TotalExento']/2;
            $empleadoNomina[0]->nomina->percepcionesTotales['TotalSueldos'] = $empleadoNomina[0]->nomina->percepcionesTotales['TotalSueldos']/2;
          }
